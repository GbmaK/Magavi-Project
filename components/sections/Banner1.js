                        ...
                        <div className="col-lg-12">
                            <div className="banner-content ta-animated-headline">
                                <h2 className="title ah-headline wow fadeInUp" data-wow-delay=".2s">
                                    ...
                                    <Typewriter tag="span"
                                        options={{
                                            ...
                                            strings: ['Inteligencia Artificial', 'Big Data', 'Blockchain'],
                                            autoStart: true,
                                            loop: true,
                                        }}
                                    />
                                ...
                                <div className="banner-btn">
                                    ...
                                    <Link href="/work" className="gradient-btn gradient-btn-two wow fadeInRight" data-wow-delay=".6s">how dex.ai work</Link>
                                </div>
                            </div>
                        </div>
                    </div>
